				...
				if (mysqli_num_rows($check_username)==0) {
					if (strlen($username)>3) {
						if (strlen($password)>7) {
							...
							$query = "INSERT INTO `admin`(`name`, `email`, `username`, `password`, `status`) VALUES ('$name', '$email', '$username', '$password','inactive');";
						...
						$usernamelan= 'This username more than 3 charset';
					}
				}else{
...
<html lang="en">
  ...
  <body>
    <div class="container"><br>
          <h1 class="text-center">Register Admin Account!</h1><hr><br>
