...
$order_id = "BSHM" . strval(mt_rand(100000, 999999));

$d_status = 0;

$timest = date("d-M-Y h:i");


$sql = "INSERT INTO orders(order_id,user_id,food_id,user_name, timestamp, delivery_status) VALUES(?,?,?,?,?,?)";

$query  = $pdoconn->prepare($sql);

if ($query->execute([$order_id, $user_id, $food_id, $user_name, $timest, $d_status])) {
