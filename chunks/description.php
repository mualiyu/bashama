<section class="fdes">
		<div class="section white center">
			<h2 class="header" style="padding:20px; padding-bottom: 30px;">Resturant Powered By Bashama</h2>
		      <div class="row container center">
			  <?php
			  	if(!isset($_SESSION["user"])){
					  echo '<div class="col center s12">
					  			<a href="#" class="waves-effect waves-light btn modal-trigger" data-target="modal2" style="font-size:20px; background: #ee6e73 !important;">Get Started &raquo;</a>
				  			</div><br>';
				  }
			  ?>
