...
$sql = 'SELECT orders.order_id, orders.user_name, orders.timestamp, orders.delivery_status, food.fname FROM orders LEFT JOIN food ON orders.food_id = food.id';
          ...
          <?php
            ...
            foreach ($arr_all as $key) {
              ...
              if($key['delivery_status'] == 1){
                ...
                $d_status = "<span style='background-color:red;' class='btn'>Waiting!!</span>";
              }
          ?>
          <tr>
