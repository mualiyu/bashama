...
<head>
	<meta charset="UTF-8">
	<title>Bashama - The Perfect Food at Your Door!</title>
...
<body>
	...
	<?php require('chunks/location.php'); ?>


	<?php require('chunks/comment-modal.php'); ?>


	<?php require('chunks/info-modal.php'); ?>


	<?php require('chunks/profile-modal.php'); ?>

	
	<?php require('chunks/order-modal.php'); ?>
